...
|7.  Random Constant Range			| 80       |Maximum / Minimum range values of the random constants used. Whatever the value, negative constants of the same magnitude are also generated in the range of -Range to +Range.|
|8.  Generation Operator Probability                           | 0.5     |Probability of generating a gene corresponding to an operator (+ - * / sin cos, log ...).|

|12.  Log Path                           | log/     |Directory where the files generated by M5GP will be stored.|
